...
alter table t_stored_card add COLUMN url VARCHAR ;
alter table t_stored_card add COLUMN content VARCHAR;
alter table t_stored_card add COLUMN money VARCHAR;
